 ...
 */
package org.ow2.authzforce.authzen.pdp.ext.test;
 ...
 */
public final class AuthZenPdpEngineAccessEvaluationTest
{
	/**
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(AuthZenPdpEngineAccessEvaluationTest.class);
